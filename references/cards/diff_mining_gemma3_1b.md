...
Battery: `seeds, bootstrap, templates, hyperparams` — 51 runs (seed 42, 15.567s)

## Checks

| check | value | 95% CI | threshold | state |
|---|---|---|---|---|
| structural stability | 0.845 | [0.747, 0.926] | ≥ 0.800 | ⚠️ inconclusive |
| claim stability | 0.961 | [0.902, 1.000] | ≥ 0.800 | ✅ pass |
| score stability | 0.099 | [0.028, 0.163] | ≤ 0.250 | ✅ pass |
| beats random | 2430.341 | [2148.808, 2664.012] | ≥ 3.000 | ✅ pass |
| specificity | 12.764 | [8.967, 18.283] | ≥ 1.500 | ✅ pass |
...
| mean pairwise Jaccard | 0.845 |
| min pairwise Jaccard | 0.031 |
| random-null Jaccard | 0.000 |
| overlap vs random (×) | 2430.341 |
| claim flip rate | 0.077 |
| modal claim share π* | 0.961 |
| distinct claims | 2 |
| score mean | 0.640 |
| score CV | 0.099 |
| median finding size | 100 |
| Jaccard 95% CI (bootstrap) | [0.747, 0.926] |
| flip rate 95% CI (bootstrap) | [0.000, 0.185] |
| null-control (specificity) | Jaccard 0.066 · flip 0.227 on 41 null runs |
| claim distribution | `top-100 domain share >=0.5; top-20 >=0.5`×49, `top-100 domain share 0.25-0.5; top-20 >=0.5`×2 |
...
|---|---|---|---|---|---|
| bootstrap | 21 | 0.960 | 0.000 | 1.000 | 0.012 |
| hyperparams | 9 | 0.427 | 0.389 | 0.778 | 0.237 |
| seeds | 21 | 0.968 | 0.000 | 1.000 | 0.012 |
...
- null control (scrambled adapter: LoRA A input features permuted, norms kept): top-100 domain share 0.00-0.36 over 41 runs; top-10 of the null base ['…)', '㕸', '叓', '諰', '䨘', '▁¿?', '訲', '𝕐', '.)', '䒑']
...
*Generated by [StressKit](https://github.com/Arth-Singh/Stresskit) v1.0.0.dev0 · schema 0.4 · 2026-09-02T10:31:22+00:00*
